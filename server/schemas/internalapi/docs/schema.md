...
- [v1/schema.proto](#v1_schema-proto)
    ...
    - [DeleteProjectByWorkspaceAliasAndProjectAliasRequest](#reearth-visualizer-v1-DeleteProjectByWorkspaceAliasAndProjectAliasRequest)
    - [DeleteProjectByWorkspaceAliasAndProjectAliasResponse](#reearth-visualizer-v1-DeleteProjectByWorkspaceAliasAndProjectAliasResponse)
    ...
    - [GetAllProjectsRequest](#reearth-visualizer-v1-GetAllProjectsRequest)
    - [GetAllProjectsResponse](#reearth-visualizer-v1-GetAllProjectsResponse)
    - [GetProjectByWorkspaceAliasAndProjectAliasRequest](#reearth-visualizer-v1-GetProjectByWorkspaceAliasAndProjectAliasRequest)
    - [GetProjectByWorkspaceAliasAndProjectAliasResponse](#reearth-visualizer-v1-GetProjectByWorkspaceAliasAndProjectAliasResponse)
    ...
    - [PatchStarCountRequest](#reearth-visualizer-v1-PatchStarCountRequest)
    - [PatchStarCountResponse](#reearth-visualizer-v1-PatchStarCountResponse)
    ...
    - [Topics](#reearth-visualizer-v1-Topics)
    - [UpdateProjectByWorkspaceAliasAndProjectAliasRequest](#reearth-visualizer-v1-UpdateProjectByWorkspaceAliasAndProjectAliasRequest)
    - [UpdateProjectByWorkspaceAliasAndProjectAliasResponse](#reearth-visualizer-v1-UpdateProjectByWorkspaceAliasAndProjectAliasResponse)
    ...
    - [ProjectVisibility](#reearth-visualizer-v1-ProjectVisibility)
...
| topics | [string](#string) | repeated | Project topics |
...
<a name="reearth-visualizer-v1-DeleteProjectByWorkspaceAliasAndProjectAliasRequest"></a>

### DeleteProjectByWorkspaceAliasAndProjectAliasRequest
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workspace_alias | [string](#string) |  | Workspace alias |
...
<a name="reearth-visualizer-v1-DeleteProjectByWorkspaceAliasAndProjectAliasResponse"></a>

### DeleteProjectByWorkspaceAliasAndProjectAliasResponse
Response messages
...
<a name="reearth-visualizer-v1-GetAllProjectsRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| keyword | [string](#string) | optional | Keyword search (searches in project name) |
...
| visibility | [ProjectVisibility](#reearth-visualizer-v1-ProjectVisibility) | optional | Visibility filter, defaults to public if not provided |
| topics | [string](#string) | repeated | Topics filter - if provided, filters projects by these topics |
...
<a name="reearth-visualizer-v1-GetAllProjectsResponse"></a>
...
<a name="reearth-visualizer-v1-GetProjectByWorkspaceAliasAndProjectAliasRequest"></a>

### GetProjectByWorkspaceAliasAndProjectAliasRequest
...
<a name="reearth-visualizer-v1-GetProjectByWorkspaceAliasAndProjectAliasResponse"></a>

### GetProjectByWorkspaceAliasAndProjectAliasResponse
Response messages
...
<a name="reearth-visualizer-v1-PatchStarCountRequest"></a>

### PatchStarCountRequest
...
<a name="reearth-visualizer-v1-PatchStarCountResponse"></a>

### PatchStarCountResponse
Response messages


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| projectmetadata | [ProjectMetadata](#reearth-visualizer-v1-ProjectMetadata) |  | Project |
...
| star_count | [int64](#int64) | optional | Project star_count |
| starred_by | [string](#string) | repeated | Project starred_by |
...
<a name="reearth-visualizer-v1-Topics"></a>
...
<a name="reearth-visualizer-v1-UpdateProjectByWorkspaceAliasAndProjectAliasRequest"></a>

### UpdateProjectByWorkspaceAliasAndProjectAliasRequest
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workspace_alias | [string](#string) |  | Workspace alias (required) |
...
<a name="reearth-visualizer-v1-UpdateProjectByWorkspaceAliasAndProjectAliasResponse"></a>

### UpdateProjectByWorkspaceAliasAndProjectAliasResponse
Response messages
...
| readme | [string](#string) | optional | Project readme |
| license | [string](#string) | optional | Project license |
| topics | [Topics](#reearth-visualizer-v1-Topics) | optional | Project topics |
...
<a name="reearth-visualizer-v1-ProjectVisibility"></a>
...
| Name | Number | Description |
| ---- | ------ | ----------- |
| PROJECT_VISIBILITY_PUBLIC | 0 | Default visibility (public projects) |
| PROJECT_VISIBILITY_PRIVATE | 1 | Private projects |
...
| GetAllProjects | [GetAllProjectsRequest](#reearth-visualizer-v1-GetAllProjectsRequest) | [GetAllProjectsResponse](#reearth-visualizer-v1-GetAllProjectsResponse) | Retrieves all projects with filtering options (no authentication required). |
...
| GetProjectByWorkspaceAliasAndProjectAlias | [GetProjectByWorkspaceAliasAndProjectAliasRequest](#reearth-visualizer-v1-GetProjectByWorkspaceAliasAndProjectAliasRequest) | [GetProjectByWorkspaceAliasAndProjectAliasResponse](#reearth-visualizer-v1-GetProjectByWorkspaceAliasAndProjectAliasResponse) | Find a project by workspace alias and project alias. Request headers: user-id: &lt;User ID&gt; |
| UpdateProjectByWorkspaceAliasAndProjectAlias | [UpdateProjectByWorkspaceAliasAndProjectAliasRequest](#reearth-visualizer-v1-UpdateProjectByWorkspaceAliasAndProjectAliasRequest) | [UpdateProjectByWorkspaceAliasAndProjectAliasResponse](#reearth-visualizer-v1-UpdateProjectByWorkspaceAliasAndProjectAliasResponse) | Update a project by workspace alias and project alias. Request headers: user-id: &lt;User ID&gt; |
| DeleteProjectByWorkspaceAliasAndProjectAlias | [DeleteProjectByWorkspaceAliasAndProjectAliasRequest](#reearth-visualizer-v1-DeleteProjectByWorkspaceAliasAndProjectAliasRequest) | [DeleteProjectByWorkspaceAliasAndProjectAliasResponse](#reearth-visualizer-v1-DeleteProjectByWorkspaceAliasAndProjectAliasResponse) | Delete a project by workspace alias and project alias. Request headers: user-id: &lt;User ID&gt; |
| PatchStarCount | [PatchStarCountRequest](#reearth-visualizer-v1-PatchStarCountRequest) | [PatchStarCountResponse](#reearth-visualizer-v1-PatchStarCountResponse) | Update a project&#39;s star count Request headers: user-id: &lt;User ID&gt; |
