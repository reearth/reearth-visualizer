...
func TestWorkspaceFilter_Merge(t *testing.T) {
	...
	assert.Equal(t, WorkspaceFilter{Readable: accountdomain.WorkspaceIDList{}}, WorkspaceFilter{}.Merge(WorkspaceFilter{Readable: accountdomain.WorkspaceIDList{}}))
	assert.Equal(t, WorkspaceFilter{Readable: accountdomain.WorkspaceIDList{}}, WorkspaceFilter{Readable: accountdomain.WorkspaceIDList{}}.Merge(WorkspaceFilter{}))
	assert.Equal(t, WorkspaceFilter{Writable: accountdomain.WorkspaceIDList{}}, WorkspaceFilter{}.Merge(WorkspaceFilter{Writable: accountdomain.WorkspaceIDList{}}))
	assert.Equal(t, WorkspaceFilter{Writable: accountdomain.WorkspaceIDList{}}, WorkspaceFilter{Writable: accountdomain.WorkspaceIDList{}}.Merge(WorkspaceFilter{}))
}
