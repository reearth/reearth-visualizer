...
// UserAdapter adapts old reearthx memory user repo to new interface
type UserAdapter struct {
	inner *accountmemory.User
}

func NewUserAdapter() accountsRepo.User {
	return &UserAdapter{
		inner: accountmemory.NewUser(),
	}
}
