...
var upstreamMessages = []struct {
	...
	{"invalid email", ClassInvalidInput},
	{"invalid password", ClassInvalidInput},
	{"invalid secret", ClassInvalidInput},
	{"password at least 8 characters", ClassInvalidInput},
	{"password should have", ClassInvalidInput},
