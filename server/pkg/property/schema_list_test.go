...
func TestSchemaList_Find(t *testing.T) {
	p1 := &Schema{id: id.MustPropertySchemaID("foo~1.0.0/a")}
	p2 := &Schema{id: id.MustPropertySchemaID("bar~1.0.0/a")}
	assert.Equal(t, p1, SchemaList{p1, p2}.Find(p1.ID()))
	assert.Nil(t, SchemaList{p1, p2}.Find(id.MustPropertySchemaID("hoge~1.0.0/a")))
...
func TestSchemaList_MapToIDs(t *testing.T) {
	p1 := &Schema{id: id.MustPropertySchemaID("foo~1.0.0/a")}
	p2 := &Schema{id: id.MustPropertySchemaID("bar~1.0.0/a")}
	assert.Equal(t, SchemaList{nil, p2}, SchemaList{p1, p2}.MapToIDs([]id.PropertySchemaID{id.MustPropertySchemaID("hoge~1.0.0/a"), p2.ID()}))
