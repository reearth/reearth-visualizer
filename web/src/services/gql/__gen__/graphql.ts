...
export type GetMeQuery = { __typename?: 'Query', me?: { __typename?: 'Me', id: string, name: string, email: string, lang: string, theme: Theme, auths: Array<string>, myWorkspace?: { __typename?: 'Workspace', id: string, name: string, alias: string, policyId?: string | null, policy?: { __typename?: 'Policy', id: string, name: string, projectCount?: number | null, memberCount?: number | null, publishedProjectCount?: number | null, layerCount?: number | null, assetStorageSize?: number | null } | null } | null, workspaces: Array<{ __typename?: 'Workspace', id: string, name: string, alias: string, personal: boolean, policyId?: string | null, members: Array<{ __typename?: 'WorkspaceMember', userId: string, role: Role, user?: { __typename?: 'User', id: string, name: string, email: string } | null }>, policy?: { __typename?: 'Policy', id: string, name: string, projectCount?: number | null, memberCount?: number | null, publishedProjectCount?: number | null, layerCount?: number | null, assetStorageSize?: number | null } | null }> } | null };
...
export type WorkspacePolicyCheckQuery = { __typename?: 'Query', workspacePolicyCheck?: { __typename?: 'PolicyCheckPayload', workspaceId: string, enableToCreatePrivateProject: boolean } | null };
