...
export type GetDeletedProjectsQuery = { __typename?: 'Query', deletedProjects: { __typename?: 'ProjectConnection', totalCount: number, nodes: Array<{ __typename?: 'Project', id: string, name: string, isDeleted: boolean, imageUrl?: string | null, visibility: string, starred: boolean } | null> } };
