...
export type WorkspacePolicyCheckQuery = { __typename?: 'Query', workspacePolicyCheck?: { __typename?: 'PolicyCheckPayload', workspaceId: string, enableToCreatePrivateProject: boolean, disableOperationByOverUsedSeat: boolean } | null };
