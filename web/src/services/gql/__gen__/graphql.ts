...
export type GetProjectQuery = { __typename?: 'Query', node?: { __typename?: 'Asset', id: string } | { __typename?: 'Project', id: string, teamId: string, name: string, description: string, imageUrl?: string | null, isArchived: boolean, isBasicAuthActive: boolean, basicAuthUsername: string, basicAuthPassword: string, publicTitle: string, publicDescription: string, publicImage: string, publishedAt?: Date | null, publicNoIndex: boolean, alias: string, enableGa: boolean, trackingId: string, publishmentStatus: PublishmentStatus, updatedAt: Date, createdAt: Date, coreSupport: boolean, starred: boolean, isDeleted: boolean, visualizer: Visualizer, visibility: string, projectAlias: string, scene?: { __typename?: 'Scene', id: string } | null, metadata?: { __typename?: 'ProjectMetadata', id: string, project: string, workspace: string, readme?: string | null, license?: string | null, importStatus?: ProjectImportStatus | null, createdAt?: Date | null, updatedAt?: Date | null } | null } | { __typename?: 'Property', id: string } | { __typename?: 'Scene', id: string } | { __typename?: 'Story', id: string } | { __typename?: 'StoryBlock', id: string } | { __typename?: 'StoryPage', id: string } | { __typename?: 'Team', id: string } | { __typename?: 'User', id: string } | null };
...
export type GetProjectsQuery = { __typename?: 'Query', projects: { __typename?: 'ProjectConnection', totalCount: number, edges: Array<{ __typename?: 'ProjectEdge', node?: { __typename?: 'Project', id: string, teamId: string, name: string, description: string, imageUrl?: string | null, isArchived: boolean, isBasicAuthActive: boolean, basicAuthUsername: string, basicAuthPassword: string, publicTitle: string, publicDescription: string, publicImage: string, publishedAt?: Date | null, publicNoIndex: boolean, alias: string, enableGa: boolean, trackingId: string, publishmentStatus: PublishmentStatus, updatedAt: Date, createdAt: Date, coreSupport: boolean, starred: boolean, isDeleted: boolean, visualizer: Visualizer, visibility: string, projectAlias: string, scene?: { __typename?: 'Scene', id: string } | null, metadata?: { __typename?: 'ProjectMetadata', id: string, project: string, workspace: string, readme?: string | null, license?: string | null, importStatus?: ProjectImportStatus | null, createdAt?: Date | null, updatedAt?: Date | null } | null } | null }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } };
...
export type UpdateProjectMutation = { __typename?: 'Mutation', updateProject?: { __typename?: 'ProjectPayload', project: { __typename?: 'Project', id: string, teamId: string, name: string, description: string, imageUrl?: string | null, isArchived: boolean, isBasicAuthActive: boolean, basicAuthUsername: string, basicAuthPassword: string, publicTitle: string, publicDescription: string, publicImage: string, publishedAt?: Date | null, publicNoIndex: boolean, alias: string, enableGa: boolean, trackingId: string, publishmentStatus: PublishmentStatus, updatedAt: Date, createdAt: Date, coreSupport: boolean, starred: boolean, isDeleted: boolean, visualizer: Visualizer, visibility: string, projectAlias: string, metadata?: { __typename?: 'ProjectMetadata', id: string, project: string, workspace: string, readme?: string | null, license?: string | null, importStatus?: ProjectImportStatus | null, createdAt?: Date | null, updatedAt?: Date | null } | null } } | null };
