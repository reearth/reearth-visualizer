...
// Set a modal window
// Documentation for Modal "show" method https://docs.reearth.io/developer/plugin/api-reference/modal/?utm_source=visualizer#show
...
reearth.extension.on("message", msg => {
  if (msg.action === "closeModal") {
    ...
    // Documentation for Modal "close" method https://docs.reearth.io/developer/plugin/api-reference/modal/?utm_source=visualizer#close
    reearth.modal.close();
  }
});`
};
