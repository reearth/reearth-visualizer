...
// Documentation for Extension "on" event https://docs.reearth.io/developer/plugin/api-reference/extension/?utm_source=visualizer#message
reearth.extension.on("message", (msg) => {
  if (msg.type === "showPopup") {
  // Documentation for Popup "show" method https://docs.reearth.io/developer/plugin/api-reference/popup/?utm_source=visualizer#show
    reearth.popup.show(popupHTML, { position: "bottom-start" });
  }
  else if (msg.type === "closePopup") {
  // Documentation for Popup "close" method https://docs.reearth.io/developer/plugin/api-reference/popup/?utm_source=visualizer#close
    reearth.popup.close();
    // Notify UI that popup is closed
    // Documentation for Extension "postMessage" method https://docs.reearth.io/developer/plugin/api-reference/ui/?utm_source=visualizer#postmessage
    reearth.ui.postMessage({ type: "popupClosed" });
  }
  else if (msg.type === "updatePopup") {
  // Documentation for Popup "update" method https://docs.reearth.io/developer/plugin/api-reference/popup/?utm_source=visualizer#update
  ...
  // Documentation for Popup "postMessage" method https://docs.reearth.io/developer/plugin/api-reference/popup/?utm_source=visualizer#postmessage
