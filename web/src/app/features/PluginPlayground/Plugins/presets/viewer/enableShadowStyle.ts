...
// Documentation for Timeline "setTime" method https://docs.reearth.io/developer/plugin/api-reference/timeline/?utm_source=visualizer#settime
...
reearth.extension.on("message", (msg) => {
  ...
  // Documentation for Viewer "overrideProperty" method https://docs.reearth.io/developer/plugin/api-reference/viewer/?utm_source=visualizer#overrideproperty
    reearth.viewer.overrideProperty({
      scene: {
        shadow: {
          enabled: false,
