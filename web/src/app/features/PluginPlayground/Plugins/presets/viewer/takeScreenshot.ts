...
reearth.extension.on('message', msg => {
  if (msg.type === 'capture-request') {
    try {
      ...
      // Documentation for Viewer "capture" method: https://docs.reearth.io/developer/plugin/api-reference/viewer/?utm_source=visualizer#capture
      const imageData = reearth.viewer.capture('image/png');

      // Check if capture was successful and send response
      // Documentation for UI "postMessage" method: https://docs.reearth.io/developer/plugin/api-reference/ui/?utm_source=visualizer#postmessage
