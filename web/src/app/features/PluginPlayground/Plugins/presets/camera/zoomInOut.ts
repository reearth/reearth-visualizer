...
reearth.extension.on("message", (msg) => {
  ...
  if (action === "zoomIn") {
    ...
    // Documentation on Camera "zoomIn" method: https://docs.reearth.io/developer/plugin/api-reference/camera/?utm_source=visualizer#zoomin
    reearth.camera.zoomIn(2);
  } else if (action === "zoomOut") {
  // Documentation on Camera "zoomOut" method: https://docs.reearth.io/developer/plugin/api-reference/camera/?utm_source=visualizer#zoomout
