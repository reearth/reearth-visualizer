...
function handleLayerSelect(layerId, featureId) {
  ...
  // Documentation on UI "postMessage" event: https://docs.reearth.io/developer/plugin/api-reference/ui/?utm_source=visualizer#postmessage
  reearth.ui.postMessage({
    action: "buildingClick",
...
// Documentation on Layers "on" event: https://docs.reearth.io/developer/plugin/api-reference/layers/?utm_source=visualizer#select-1
