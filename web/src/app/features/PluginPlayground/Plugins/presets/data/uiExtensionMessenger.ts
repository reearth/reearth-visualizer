...
// Documentation on Viewer "on" event: https://docs.reearth.io/developer/plugin/api-reference/viewer/?utm_source=visualizer#mouse-events
...
reearth.extension.on("message", msg => {
  if (msg.type === "fly") {
  // Documentation on Camera "flyTo" method: https://docs.reearth.io/developer/plugin/api-reference/camera/?utm_source=visualizer#flyto
