...
// Documentation on Client Storage "getAsync" method: https://docs.reearth.io/developer/plugin/api-reference/data/?utm_source=visualizer#getasync
  const theme = await reearth.data.clientStorage.getAsync(THEME_KEY);
  // Documentation on UI "postMessage" method: https://docs.reearth.io/developer/plugin/api-reference/ui/?utm_source=visualizer#postmessage
...
reearth.extension.on("message", async msg => {
  try {
    switch (msg.type) {
      ...
      case "setTheme":
        // Documentation on Client Storage "setAsync" method: https://docs.reearth.io/developer/plugin/api-reference/data/?utm_source=visualizer#setasync
      ...
      case "viewKeys":
        // Documentation on Client Storage "keysAsync" method: https://docs.reearth.io/developer/plugin/api-reference/data/?utm_source=visualizer#keysasync
      ...
      case "clearStorage":
        // Documentation on Client Storage "dropStoreAsync" method: https://docs.reearth.io/developer/plugin/api-reference/data/?utm_source=visualizer#dropstoreasync
