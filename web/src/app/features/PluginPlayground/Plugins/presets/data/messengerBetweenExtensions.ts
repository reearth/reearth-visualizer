...
reearth.extension.on("message", msg => {
  if (msg.type === "send") {
  // Documentation on Extension List https://docs.reearth.io/developer/plugin/api-reference/extension/?utm_source=visualizer#list
    const extensions = reearth.extension.list;
    const target = extensions.find(ext => ext.extensionId === "extension-2");
    if (target) {
    // Documentation on Extension "postMessage" method https://docs.reearth.io/developer/plugin/api-reference/extension/?utm_source=visualizer#postmessage
