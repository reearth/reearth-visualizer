...
const Wrapper = styled.div`
  ...
  box-shadow: 0 0 5px ${props => props.theme.classic.infoBox.deepBg};
  &:after {
    content: "";
    position: absolute;
    right: 0;
    ...
    margin: auto;
    border-style: solid;
    border-color: transparent transparent ${props => props.theme.classic.infoBox.bg} transparent;
...
const ContentButton = styled.div`
  ...
  &:hover {
    border-radius: 6px;
    border: solid 0.5px ${props => props.theme.classic.main.select};
  }
`;
